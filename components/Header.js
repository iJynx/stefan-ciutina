      ...
      <div className="grid max-w-lg grid-cols-1 justify-items-center gap-8">
        ...
        {(prismicH.isFilled.richText(name) ||
          ...
          <div className="grid grid-cols-1 gap-2 text-center">
            ...
            {prismicH.isFilled.richText(description) && (
              <p className="font-serif text-2xl italic leading-normal tracking-tight text-slate-500 dark:text-secondary">
...
const NavItem = ({ children }) => {
  return (
    <li className="font-semibold tracking-tight text-slate-800 dark:text-primary">{children}</li>
  );
};
